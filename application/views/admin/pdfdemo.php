                ...
                <div class="page-wrapper">
                  ...
                  <div class="wrapper">
                    ...
                    <form action="#">
                      ...
                      <button type="button" style="height: 100%;color: #fff;outline: none;border: none;font-size: 18px;font-weight: 500;cursor: pointer;border-radius: 5px;letter-spacing: 1px;background: linear-gradient(135deg, #71B7E6, #9B59B6);">View Document</button>
                      <button type="button" style="height: 100%;color: #fff;outline: none;border: none;font-size: 18px;font-weight: 500;cursor: pointer;border-radius: 5px;letter-spacing: 1px;background: linear-gradient(135deg, #71B7E6, #9B59B6);">View Document</button>
                      <button type="button" style="height: 100%;color: #fff;outline: none;border: none;font-size: 18px;font-weight: 500;cursor: pointer;border-radius: 5px;letter-spacing: 1px;background: linear-gradient(135deg, #71B7E6, #9B59B6);">View Document</button>
                      <button type="button" style="height: 100%;color: #fff;outline: none;border: none;font-size: 18px;font-weight: 500;cursor: pointer;border-radius: 5px;letter-spacing: 1px;background: linear-gradient(135deg, #71B7E6, #9B59B6);">View Document</button>
                    ...
                    width: calc(100% / 4 - 20px);">
                        ...
                        <!-- <input type="text" placeholder="URL" style="width:20%;outline: none;border-radius: 5px;border: 1px solid #ccc;padding-left: 15px;font-size:16px;
                    border-bottom-width: 2px;transition: all .3s ease;height: 45px;">
                     <input type="text" placeholder="URL" style="width:20%;outline: none;border-radius: 5px;border: 1px solid #ccc;padding-left:15px;font-size:16px;
                    border-bottom-width: 2px;transition: all .3s ease;height: 45px;">
                      <input type="text" placeholder="URL" style="width:20%;outline: none;border-radius:5px;border: 1px solid #ccc;padding-left:15px;font-size:16px;
                    border-bottom-width: 2px;transition: all .3s ease;height: 45px;">
