                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Advertisement Details</h5>
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a>Advertisement Details</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <div style="display: flex; justify-content: flex-end;">
                                                <a href="<?php echo base_url(); ?>AddNewAddvertisementForm">
                                                        ...
                                                        <tbody id="myTable">
                                                            ...
                                                            <?php foreach ($advertisementdetails as $row) : ?>
                                                                <tr>
                                                                    ...
                                                                    <td> <img src="<?php echo  "https://maclareenai.com/mtas/upload/advertisement/" . $row->ad_image_path; ?>" width="150px"></td>
                                                                    <td><?php $time =  $row->added_date;
                                                                            $date= new DateTime($time);
                                                                            $AddedDate = $date->format('F j, Y, g:i A');
                                                                            echo $AddedDate;?></td>
                                                                    <td> <?php if ($row->is_active == "0") { ?>
                                                                            <a href="<?php echo base_url('UpdateAdvertisementStatus/' . $row->is_active . '/' . $row->ad_id); ?>" style="text-decoration: none;">
                                                                                <button style="background-color: #2ECC71; color: white; border: none; border-radius: 6px; padding: 10px 20px; font-size: 16px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2), 0 6px 20px rgba(0, 0, 0, 0.15); transition: all 0.3s ease;">
                                                                                    Active
                                                                                </button>
                                                                            </a>
